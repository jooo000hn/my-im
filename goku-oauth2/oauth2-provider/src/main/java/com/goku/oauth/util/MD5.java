...
public class MD5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(m.getMD5ofStr("9B7ITO3gLJUKMqj1T8C8S3KaG6H1MuCp"));

        String md5s = "acgame" + "acgame-client" + "be077924b491215431f5b5edee51ec782aad26c17d3731e0b44273f6e28386ffad248aca5194a3c2befd62a03da4f4b8df3b8cec928bc7a58ef9e1714895054fbd2b4b71eee750e33d99d435d249af62" + "12" + "15811265691";
        if(!m.getMD5ofStr(md5s).equals("c5339875826700f2900c6326fa4c0098")) {
            String error = "params b is error";
            throw new ServiceException("000", error);
        }
        if(Array.getLength(args) == 0) {
            ...
            try {
                ...
                e.update("a".getBytes());
//                System.out.println(EncryptUtil.encodeHex(e.digest()));
