...
public class EncryptUtil {
	...
	public static final byte[] desKey = new byte[] { (byte) 64, (byte) -77, (byte) 35, (byte) -45, (byte) 16,
			(byte) -22, (byte) 121, (byte) -15 };
	...
	public static String decrytUserId(String tokenValue) {
		// String tokenDecryt = EncryptUtil.decryptString(tokenValue);
