 ...
 * @version 1.0.0<br/>
 */
public class IMRequestHandler extends AbstractIMHandler<IMRequest> {
	
	private Logger logger = LoggerFactory.getLogger(IMRequestHandler.class);
