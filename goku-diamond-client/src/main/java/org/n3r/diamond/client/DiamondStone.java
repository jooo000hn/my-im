...
public class DiamondStone {
	...
	public String toString() {
		return "DiamondStone{" + "diamondAxis=" + diamondAxis + ", content=" + content + '}';
	}
	...
	public boolean equals(Object o) {
		...
		if (diamondAxis != null ? !diamondAxis.equals(diamondStone.diamondAxis) : diamondStone.diamondAxis != null)
			return false;
