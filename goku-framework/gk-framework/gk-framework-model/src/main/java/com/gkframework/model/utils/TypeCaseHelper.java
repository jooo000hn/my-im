...
public class TypeCaseHelper {
	...
	public static Object convert(Object obj, String type, String format) throws RuntimeException {
		...
		if (obj instanceof String) {
			...
			if ("Double".equals(type) || "java.lang.Double".equals(type))
				try {
					...
					throw new RuntimeException("Could not convert " + str + " to " + type + ": "+e.getMessage());
				}
			if ("BigDecimal".equals(type) || "java.math.BigDecimal".equals(type))
				try {
					...
					throw new RuntimeException("Could not convert " + str + " to " + type + ": ");
				}
			...
			if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type)) {
				...
				throw new RuntimeException("Conversion from " + fromType + " to " + type
		...
		if ("String".equals(type) || "java.lang.String".equals(type))
			...
			throw new RuntimeException("Conversion from " + obj.getClass().getName() + " to "
