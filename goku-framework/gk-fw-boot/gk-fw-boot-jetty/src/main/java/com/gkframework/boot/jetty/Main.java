package com.gkframework.boot.jetty;
...
import com.gkframework.boot.jetty.spring.SpringContainer;
import com.gkframework.boot.jetty.spring.SpringContainerManager;
		...
		try {
			...
			for (Container container : containers) {
                try {
					...
					ObjectName oname = ObjectName.getInstance("tv.acframework", properties);
