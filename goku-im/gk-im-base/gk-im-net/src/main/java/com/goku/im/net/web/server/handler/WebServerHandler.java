...
import io.goku.chat.core.webtransport.IMWebRequest;
 ...
 * 处理接收到的数据
 */
public class WebServerHandler extends SimpleChannelInboundHandler<IMWebRequest> {
	...
	@Override
	protected void messageReceived(ChannelHandlerContext ctx, IMWebRequest msg) throws Exception {
