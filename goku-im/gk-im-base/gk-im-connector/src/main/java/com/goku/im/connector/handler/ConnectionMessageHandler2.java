 ...
 */
@Component
public class ConnectionMessageHandler2 implements SocketExecuteHandler {
	...
	public SocketResponse execute(SocketRequestContext context) {
		...
		try {
			...
			e.printStackTrace();
			logger.error("at ConnectionMessageHandler.execute throw an error. request:" + logMessage.toString()
